...
namespace rz
{
    ...
    class TeamPlayGameRules : public HalfLifeMultiplay
    {
      public:
        ...
        auto IsAllowedToSpawn(EntityBase*) -> qboolean override
        {
            return true;
        }

        auto AllowFlashlight() -> qboolean override
        {
            return mp_flashlight->value ? true : false;
        }
        ...
        auto IsMultiplayer() -> qboolean override
        {
            return true;
        }

        auto IsDeathmatch() -> qboolean override
        {
            return true;
        }

        auto IsTeamplay() -> qboolean override
        {
            return true;
        }

        auto IsCoop() -> qboolean override
        {
            return false;
        }
        ...
        auto ShouldAutoAim(PlayerBase*, Edict*) -> qboolean override
        {
            return false;
        }
        ...
        auto PlayerSpawnTime(PlayerBase*) -> float override
        {
            return 0.f;
        };
        ...
        auto AllowAutoTargetCrosshair() -> qboolean override
        {
            return false;
        }
        ...
        auto CanHavePlayerItem(PlayerBase*, PlayerItemBase*) -> qboolean override
        {
            return true;
        }
        ...
        auto WeaponShouldRespawn(PlayerItemBase*) -> WeaponRespawnCode override
        {
            return WeaponRespawnCode::WeaponRespawnNo;
        }

        auto WeaponRespawnTime(PlayerItemBase*) -> float override
        {
            return -1;
        }

        auto WeaponTryRespawn(PlayerItemBase*) -> float override
        {
            return -1;
        }

        auto WeaponRespawnSpot(PlayerItemBase*) -> Vector override
        {
            return VECTOR_ZERO;
        }

        auto CanHaveItem(PlayerBase*, Item*) -> qboolean override
        {
            return false;
        }
        ...
        auto ItemShouldRespawn(Item*) -> WeaponRespawnCode override
        {
            return WeaponRespawnCode::ItemRespawnNo;
        }

        auto ItemRespawnTime(Item*) -> float override
        {
            return -1;
        }

        auto ItemRespawnSpot(Item*) -> Vector override
        {
            return VECTOR_ZERO;
        }

        auto CanHaveAmmo(PlayerBase*, const char*, int) -> qboolean override
        {
            return true;
        }
        ...
        auto AmmoShouldRespawn(PlayerAmmoBase*) -> WeaponRespawnCode override
        {
            return WeaponRespawnCode::AmmoRespawnNo;
        }

        auto AmmoRespawnTime(PlayerAmmoBase*) -> float override
        {
            return -1;
        }

        auto AmmoRespawnSpot(PlayerAmmoBase*) -> Vector override
        {
            return VECTOR_ZERO;
        }

        auto HealthChargerRechargeTime() -> float override
        {
            return 0;
        }

        auto HevChargerRechargeTime() -> float override
        {
            return 0;
        }
        ...
        auto PlayTextureSounds() -> qboolean override
        {
            return false;
        };

        auto AllowMonsters() -> qboolean override
        {
            return false;
        }
        ...
        auto IsFreezePeriod() -> qboolean override
        {
            return false;
        }
        ...
        auto GetAccountRules(RewardRules) const -> int override
        {
            return 0;
        }

        auto IsThereABomber() -> qboolean override
        {
            return false;
        }

        auto IsThereABomb() -> qboolean override
        {
            return false;
        }
        ...
        auto HasRoundTimeExpired() -> bool override
        {
            return false;
        }

        auto IsBombPlanted() -> bool override
        {
            return false;
        }
        ...
        auto getRandomGameMode() const -> int;

        auto SendMotdToClient(const Player& player) -> void;

        auto CountPlayers() -> void;

        auto GetRoundRemainingTime() const;
        auto GetRoundRemainingTimeReal() const;
        auto GetTimeLeft() const;
        auto GetRoundElapsedTime() const;
        auto GetMapElapsedTime() const;
        auto GetRoundRespawnTime() const;
        auto getPlayersCount(Team team) const -> int;
        auto setPlayersCount(Team team, int playersCount) -> void;
        auto getTeamWins(Team team) const -> short;
        auto setTeamWins(Team team, short wins, bool update = true) -> void;
        ...
        auto getGameMode() const -> int;
        auto setGameMode(int gameModeIndex) -> void;
        auto getLastGameMode() const -> int;
        auto setLastGameMode(int lastGameModeIndex) -> void;
