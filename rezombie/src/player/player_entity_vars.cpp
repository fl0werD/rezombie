...
namespace rz::player
{
    ...
    auto Player::setRenderColor(const Color24& color) -> void
    {
        vars_->render_color = Vector(color.red, color.green, color.blue);
    }
    ...
    auto Player::getIUser1() const -> ObserverMode
    {
