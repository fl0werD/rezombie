...
namespace rz
{
    ...
    auto Player::getIntroCamera() const -> EntityBase* {
        return base_->intro_camera;
    }

    auto Player::setIntroCamera(EntityBase* camera) -> void {
        base_->intro_camera = camera;
    }

    auto Player::getIntroCameraTime() const -> float {
        return base_->intro_cam_time;
    }

    auto Player::setIntroCameraTime(float nextCameraTime) -> void {
        base_->intro_cam_time = nextCameraTime;
    }
    ...
    auto Player::getActiveItem() const -> PlayerItem* {
        return static_cast<PlayerItem*>(base_->active_item);
    }
    ...
    auto Player::getLastCommandTime(TrackCommands command) const -> float {
        return base_->last_command_time[static_cast<int>(command)];
    }

    auto Player::setLastCommandTime(TrackCommands command, float time) -> void {
        base_->last_command_time[static_cast<int>(command)] = time;
    }

    auto Player::setHitBoxes(int modelIndex) -> void {
        base_->model_index_player = modelIndex;
    }
